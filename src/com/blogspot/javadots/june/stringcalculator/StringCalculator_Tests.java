...
public class StringCalculator_Tests extends TestBed<StringCalculator> {
   ...
   class Delimiters {
      ...
      class Custom {
         ...
         void singleX() {
            expect(3).from(new StringCalculator("//X\n1X2"));
         }

         void canBe_a_Word() {
            expect(3).from(new StringCalculator("//AB\n1AB2"));
         }

         void canBeLong() {
            expect(3).from(new StringCalculator("//ABCDEF\n1ABCDEF2"));
         }
      }
   }
   ...
   class FiresResultEvents {
      ...
      void correctInput() {
         expect(6).from(new StringCalculator("1,2,3")).addListener(
      ...
      void incorrectInput() {
         expect(null).from(new StringCalculator("-5")).addListener(
            new StringCalculatorListener() {
               public void newResult(int r) {
                  n = r;
               }
   ...
   class ErrorHandling {
      ...
      class RejectsNegatives {
         ...
         void singleNegative() {
            expect(IllegalArgumentException.class).from(
      ...
      class ReportsNegatives {
         ...
         void singleNegative() {
            expect(IllegalArgumentException.class, "Negatives: -1").from(
               new StringCalculator("-1"));
         }

         void twoNegatives() {            
            expect(IllegalArgumentException.class, "Negatives: -1 -2").from(
   ...
   class toStringReflectsInput {
      ...
      void empty() {
         expect("").from(new StringCalculator(""));
      }
